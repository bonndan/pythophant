...
class HelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->renderer = new Helper();
    }
    
    public function testSetTokenList()
    {
        $element = $this->getMock("\PythoPhant\Reflection\Element");
    ...
    public function testAddWatermark()
    {
        ...
        $doc = $this->getMockBuilder("\PythoPhant\DocCommentToken")
    ...
    public function testGetPHPSource()
    {
        ...
        $element = new \PythoPhant\Reflection\RefClass('test', $docComment);
        $this->renderer->setReflectionElement($element);
