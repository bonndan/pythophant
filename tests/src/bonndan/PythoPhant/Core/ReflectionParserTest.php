 ...
 */
class ReflectionParserTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Parser
     */
    ...
    {
        $this->tokenFactory = new RegisteredTokenFactory();
        $this->object = new ReflectionParser(
            $this->tokenFactory
        );
    }
    ...
    {
        return new TokenFactoryScanner($this->tokenFactory);
    }
...
";
        ...
        $this->assertInstanceOf("PythoPhant\Reflection\RefClass", $class);
...
";
        ...
        $this->assertInstanceOf("\PythoPhant\TokenList", $preamble);
